...
Feel free to check the [issues page](https://github.com/Tekhlay/hello-rails-back-end/issues)
...
This project is [MIT](https://github.com/Tekhlay/hello-rails-back-end/blob/dev/LICENSE) licensed.
